...
export const useRecordSupplierCredit = () => { const qc = useQueryClient(); return useMutation({ mutationFn: ({ id, data }) => supplierReturnsApi.recordCredit(id, data), onSuccess: success(qc, ['supplierReturns', 'supplierReturn', 'suppliers'], 'Credit recorded'), onError }); };
