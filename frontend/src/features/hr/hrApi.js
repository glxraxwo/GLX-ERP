...
export const employeesApi = {
    ...
    deleteDocument: async (id, data) => (await api.delete(`/hr/employees/${id}/documents`, { data })).data,
};
...
export const advancesApi = {
    ...
    getOngoingPeriod: async (params = {}) => (await api.get('/hr/advances/ongoing-period', { params })).data,
    ...
    pay: async (id, data = {}) => (await api.post(`/hr/advances/${id}/pay`, data)).data,
};