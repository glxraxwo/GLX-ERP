    ...
    const payoutMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            if (data.nextPeriod) {
                ...
                const nextMonthLabel = monthNames[data.nextPeriod.periodMonth - 1];
                const nextPeriodText = `Next salary period: ${nextMonthLabel} ${data.nextPeriod.periodYear} (Payment Date: ${new Date(data.nextPeriod.scheduledPaymentDate).toLocaleDateString('en-LK')})`;
                toast.success(nextPeriodText, { duration: 5000 });
            }
