...
import { ArrowLeft, Printer, RefreshCw, Upload, CheckSquare, Square, FileSignature, MessageSquare } from 'lucide-react';
                ...
                <div className="flex flex-wrap justify-between items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <Button variant="outline" size="sm" onClick={() => setSmsModalOpen(true)}>
                            <MessageSquare size={14} className="mr-1" /> Send SMS
                        </Button>
                    </div>
                </div>
