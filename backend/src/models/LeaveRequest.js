...
const leaveRequestSchema = new mongoose.Schema({
    ...
    // Unauthorized Leave Deduction (අවසරයකින් තොරව ගත් නිවාඩු සඳහා වැටුපෙන් කපන මුදල)
    isUnauthorized: { type: Boolean, default: false },
    unauthorizedDeductionAmount: { type: Number, default: 0 },
    unauthorizedDeductionNotes: String,
