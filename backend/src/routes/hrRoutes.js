...
import {
    ...
    createLeaveRequest, getLeaveRequests, approveLeaveRequest, rejectLeaveRequest, cancelLeaveRequest, updateUnauthorizedLeaveDeduction,
...
import { uploadEmployeeDocument as uploadDoc } from '../middleware/uploadMiddleware.js';
...
router.put('/leave-requests/:id/unauthorized-deduction', requirePermission('hr.leaves.manage'), updateUnauthorizedLeaveDeduction);
...
router.get('/advances/ongoing-period', getOngoingSalaryPeriodInfo);
...
router.post('/employees/:id/payment-sheet/send-sms', requirePermission('hr.employees.view'), sendPaymentSheetLinkSms);
...
router.get('/employees/:id/documents', protect, requirePermission('hr.employees.view'), getEmployeeDocuments);
router.delete('/employees/:id/documents', protect, requirePermission('hr.employees.manage'), deleteEmployeeDocument);
