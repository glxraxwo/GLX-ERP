...
import {
    ...
    getPublicPayslipByToken, getPeriodPayrollSummary, getNextSalaryPeriodInfo,
    sendPayslipLinkSms
...
router.get('/next-period', requirePermission('hr.payroll.view'), getNextSalaryPeriodInfo);
...
router.post('/payslips/:payslipId/send-sms', requirePermission('hr.payroll.view'), sendPayslipLinkSms);
